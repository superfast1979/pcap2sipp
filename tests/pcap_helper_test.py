...
class Test(unittest.TestCase):
    ...
    def test_getClientServerPortFromFirstPacket_when_UDP(self):
        ...
        client_port, server_port = pcap_helper.getClientServerPortFromFirstPacket(udp_packet, scapy_layers.UDP)
    ...
    def test_getClientServerPortFromFirstPacket_when_TCP(self):
        ...
        client_port, server_port = pcap_helper.getClientServerPortFromFirstPacket(tcp_packet, scapy_layers.TCP)
        self.assertEqual(5050, client_port)
        self.assertEqual(5010, server_port)
        
    def test_getClientServerProtocolFromFirstPacket_when_TCP(self):
        tcp_packet = scapy_layers.TCP()
        protocol = pcap_helper.getClientServerProtocolFromFirstPacket(tcp_packet)
        self.assertEqual(scapy_layers.TCP, protocol)
        
    def test_getClientServerProtocolFromFirstPacket_when_UDP(self):
        udp_packet = scapy_layers.UDP()
        protocol = pcap_helper.getClientServerProtocolFromFirstPacket(udp_packet)
        self.assertEqual(scapy_layers.UDP, protocol)
        
    def test_getClientServerProtocolFromFirstPacket_when_ICMP(self):
        icmp_packet = scapy_layers.ICMP()
        with self.assertRaises(SystemExit) as se:
            protocol = pcap_helper.getClientServerProtocolFromFirstPacket(icmp_packet)
        self.assertEqual(se.exception.code, 0)
    ...
    def test_getSipCallFlowFrom_when_simpleScenario(self):
        ...
        packets = [a,b]
        callFlow = pcap_helper.getSipCallFlowFrom(packets)
